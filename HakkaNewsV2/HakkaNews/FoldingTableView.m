...
-(instancetype)initWithFrame:(CGRect)frame style:(UITableViewStyle)style{
    ...
    if (self) {
        self.subclassView=[[UITableView alloc] initWithFrame:self.bounds style:style];
        self.tableView=(UITableView*)self.subclassView;
        ...
        _pullDownLayer.frame=CGRectMake(_tableView.bounds.size.width/2 - 25,60, 50, 20);
        ...
        [_tableView.layer addSublayer:_pullDownLayer];
